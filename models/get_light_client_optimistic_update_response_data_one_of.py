...
class GetLightClientOptimisticUpdateResponseDataOneOf(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    GetLightClientOptimisticUpdateResponseDataOneOf - a model defined in OpenAPI

        attested_header: The attested_header of this GetLightClientOptimisticUpdateResponseDataOneOf [Optional].
        sync_aggregate: The sync_aggregate of this GetLightClientOptimisticUpdateResponseDataOneOf [Optional].
        signature_slot: The signature_slot of this GetLightClientOptimisticUpdateResponseDataOneOf [Optional].
    """
...
GetLightClientOptimisticUpdateResponseDataOneOf.update_forward_refs()
