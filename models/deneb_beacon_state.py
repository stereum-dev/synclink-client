...
class DenebBeaconState(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    DenebBeaconState - a model defined in OpenAPI

        genesis_time: The genesis_time of this DenebBeaconState [Optional].
        genesis_validators_root: The genesis_validators_root of this DenebBeaconState [Optional].
        slot: The slot of this DenebBeaconState [Optional].
        fork: The fork of this DenebBeaconState [Optional].
        latest_block_header: The latest_block_header of this DenebBeaconState [Optional].
        block_roots: The block_roots of this DenebBeaconState [Optional].
        state_roots: The state_roots of this DenebBeaconState [Optional].
        historical_roots: The historical_roots of this DenebBeaconState [Optional].
        eth1_data: The eth1_data of this DenebBeaconState [Optional].
        eth1_data_votes: The eth1_data_votes of this DenebBeaconState [Optional].
        eth1_deposit_index: The eth1_deposit_index of this DenebBeaconState [Optional].
        validators: The validators of this DenebBeaconState [Optional].
        balances: The balances of this DenebBeaconState [Optional].
        randao_mixes: The randao_mixes of this DenebBeaconState [Optional].
        slashings: The slashings of this DenebBeaconState [Optional].
        previous_epoch_participation: The previous_epoch_participation of this DenebBeaconState [Optional].
        current_epoch_participation: The current_epoch_participation of this DenebBeaconState [Optional].
        justification_bits: The justification_bits of this DenebBeaconState [Optional].
        previous_justified_checkpoint: The previous_justified_checkpoint of this DenebBeaconState [Optional].
        current_justified_checkpoint: The current_justified_checkpoint of this DenebBeaconState [Optional].
        finalized_checkpoint: The finalized_checkpoint of this DenebBeaconState [Optional].
        inactivity_scores: The inactivity_scores of this DenebBeaconState [Optional].
        current_sync_committee: The current_sync_committee of this DenebBeaconState [Optional].
        next_sync_committee: The next_sync_committee of this DenebBeaconState [Optional].
        latest_execution_payload_header: The latest_execution_payload_header of this DenebBeaconState [Optional].
        next_withdrawal_index: The next_withdrawal_index of this DenebBeaconState [Optional].
        next_withdrawal_validator_index: The next_withdrawal_validator_index of this DenebBeaconState [Optional].
        historical_summaries: The historical_summaries of this DenebBeaconState [Optional].
    """
...
DenebBeaconState.update_forward_refs()
