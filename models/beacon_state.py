...
class BeaconState(BaseModel):
    """BeaconState - a model defined in OpenAPI

        genesis_time: The genesis_time of this BeaconState [Optional].
        genesis_validators_root: The genesis_validators_root of this BeaconState [Optional].
        slot: The slot of this BeaconState [Optional].
        fork: The fork of this BeaconState [Optional].
        latest_block_header: The latest_block_header of this BeaconState [Optional].
        block_roots: The block_roots of this BeaconState [Optional].
        state_roots: The state_roots of this BeaconState [Optional].
        historical_roots: The historical_roots of this BeaconState [Optional].
        eth1_data: The eth1_data of this BeaconState [Optional].
        eth1_data_votes: The eth1_data_votes of this BeaconState [Optional].
        eth1_deposit_index: The eth1_deposit_index of this BeaconState [Optional].
        validators: The validators of this BeaconState [Optional].
        balances: The balances of this BeaconState [Optional].
        randao_mixes: The randao_mixes of this BeaconState [Optional].
        slashings: The slashings of this BeaconState [Optional].
        previous_epoch_attestations: The previous_epoch_attestations of this BeaconState [Optional].
        current_epoch_attestations: The current_epoch_attestations of this BeaconState [Optional].
        justification_bits: The justification_bits of this BeaconState [Optional].
        previous_justified_checkpoint: The previous_justified_checkpoint of this BeaconState [Optional].
        current_justified_checkpoint: The current_justified_checkpoint of this BeaconState [Optional].
        finalized_checkpoint: The finalized_checkpoint of this BeaconState [Optional].
    """
...
BeaconState.update_forward_refs()
