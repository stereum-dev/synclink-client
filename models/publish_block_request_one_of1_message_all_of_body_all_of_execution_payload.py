...
class PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload(BaseModel):
    ...
    PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload - a model defined in OpenAPI

        parent_hash: The parent_hash of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        fee_recipient: The fee_recipient of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        state_root: The state_root of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        receipts_root: The receipts_root of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        logs_bloom: The logs_bloom of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        prev_randao: The prev_randao of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        block_number: The block_number of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        gas_limit: The gas_limit of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        gas_used: The gas_used of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        timestamp: The timestamp of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        extra_data: The extra_data of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        base_fee_per_gas: The base_fee_per_gas of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        block_hash: The block_hash of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        transactions: The transactions of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
        withdrawals: The withdrawals of this PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload [Optional].
    """
...
PublishBlockRequestOneOf1MessageAllOfBodyAllOfExecutionPayload.update_forward_refs()
