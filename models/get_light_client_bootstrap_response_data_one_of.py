...
class GetLightClientBootstrapResponseDataOneOf(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    GetLightClientBootstrapResponseDataOneOf - a model defined in OpenAPI

        header: The header of this GetLightClientBootstrapResponseDataOneOf [Optional].
        current_sync_committee: The current_sync_committee of this GetLightClientBootstrapResponseDataOneOf [Optional].
        current_sync_committee_branch: The current_sync_committee_branch of this GetLightClientBootstrapResponseDataOneOf [Optional].
    """
...
GetLightClientBootstrapResponseDataOneOf.update_forward_refs()
