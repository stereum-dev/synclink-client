...
class DenebBlindedBlobSidecar(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    DenebBlindedBlobSidecar - a model defined in OpenAPI

        block_root: The block_root of this DenebBlindedBlobSidecar [Optional].
        index: The index of this DenebBlindedBlobSidecar [Optional].
        slot: The slot of this DenebBlindedBlobSidecar [Optional].
        block_parent_root: The block_parent_root of this DenebBlindedBlobSidecar [Optional].
        proposer_index: The proposer_index of this DenebBlindedBlobSidecar [Optional].
        blob_root: The blob_root of this DenebBlindedBlobSidecar [Optional].
        kzg_commitment: The kzg_commitment of this DenebBlindedBlobSidecar [Optional].
        kzg_proof: The kzg_proof of this DenebBlindedBlobSidecar [Optional].
    """
...
DenebBlindedBlobSidecar.update_forward_refs()
