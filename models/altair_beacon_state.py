...
class AltairBeaconState(BaseModel):
    """AltairBeaconState - a model defined in OpenAPI
        ...
        slot: The slot of this AltairBeaconState [Optional].
        fork: The fork of this AltairBeaconState [Optional].
        latest_block_header: The latest_block_header of this AltairBeaconState [Optional].
        block_roots: The block_roots of this AltairBeaconState [Optional].
        state_roots: The state_roots of this AltairBeaconState [Optional].
        historical_roots: The historical_roots of this AltairBeaconState [Optional].
        eth1_data: The eth1_data of this AltairBeaconState [Optional].
        eth1_data_votes: The eth1_data_votes of this AltairBeaconState [Optional].
        eth1_deposit_index: The eth1_deposit_index of this AltairBeaconState [Optional].
        validators: The validators of this AltairBeaconState [Optional].
        balances: The balances of this AltairBeaconState [Optional].
        randao_mixes: The randao_mixes of this AltairBeaconState [Optional].
        slashings: The slashings of this AltairBeaconState [Optional].
        previous_epoch_participation: The previous_epoch_participation of this AltairBeaconState [Optional].
        current_epoch_participation: The current_epoch_participation of this AltairBeaconState [Optional].
        justification_bits: The justification_bits of this AltairBeaconState [Optional].
        previous_justified_checkpoint: The previous_justified_checkpoint of this AltairBeaconState [Optional].
        current_justified_checkpoint: The current_justified_checkpoint of this AltairBeaconState [Optional].
        finalized_checkpoint: The finalized_checkpoint of this AltairBeaconState [Optional].
        inactivity_scores: The inactivity_scores of this AltairBeaconState [Optional].
        current_sync_committee: The current_sync_committee of this AltairBeaconState [Optional].
        next_sync_committee: The next_sync_committee of this AltairBeaconState [Optional].
    """
...
AltairBeaconState.update_forward_refs()
