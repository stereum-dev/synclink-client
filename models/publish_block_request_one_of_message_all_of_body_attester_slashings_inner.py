...
class PublishBlockRequestOneOfMessageAllOfBodyAttesterSlashingsInner(BaseModel):
    """PublishBlockRequestOneOfMessageAllOfBodyAttesterSlashingsInner - a model defined in OpenAPI

        attestation_1: The attestation_1 of this PublishBlockRequestOneOfMessageAllOfBodyAttesterSlashingsInner [Optional].
        attestation_2: The attestation_2 of this PublishBlockRequestOneOfMessageAllOfBodyAttesterSlashingsInner [Optional].
    """
...
PublishBlockRequestOneOfMessageAllOfBodyAttesterSlashingsInner.update_forward_refs()
