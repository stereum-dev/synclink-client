...
class GetStateV2ResponseData(BaseModel):
    ...
    latest_execution_payload_header: Optional[PublishBlindedBlockRequestOneOfMessageAllOfBodyAllOfExecutionPayloadHeader] = Field(alias="latest_execution_payload_header", default=None)
