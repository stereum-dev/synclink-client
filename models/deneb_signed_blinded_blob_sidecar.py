...
class DenebSignedBlindedBlobSidecar(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    DenebSignedBlindedBlobSidecar - a model defined in OpenAPI

        message: The message of this DenebSignedBlindedBlobSidecar [Optional].
        signature: The signature of this DenebSignedBlindedBlobSidecar [Optional].
    """
...
DenebSignedBlindedBlobSidecar.update_forward_refs()
