...
class GetStateV2ResponseDataOneOf(BaseModel):
    ...
    GetStateV2ResponseDataOneOf - a model defined in OpenAPI
        ...
        previous_epoch_attestations: The previous_epoch_attestations of this GetStateV2ResponseDataOneOf [Optional].
        current_epoch_attestations: The current_epoch_attestations of this GetStateV2ResponseDataOneOf [Optional].
