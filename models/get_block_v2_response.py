...
from models.get_block_v2_response_data import GetBlockV2ResponseData
...
class GetBlockV2Response(BaseModel):
    ...
    GetBlockV2Response - a model defined in OpenAPI
        ...
        finalized: The finalized of this GetBlockV2Response [Optional].
    ...
    data: Optional[GetBlockV2ResponseData] = Field(alias="data", default=None)
