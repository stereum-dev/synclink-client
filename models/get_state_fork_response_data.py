...
class GetStateForkResponseData(BaseModel):
    """GetStateForkResponseData - a model defined in OpenAPI

        previous_version: The previous_version of this GetStateForkResponseData [Optional].
        current_version: The current_version of this GetStateForkResponseData [Optional].
        epoch: The epoch of this GetStateForkResponseData [Optional].
    """
...
GetStateForkResponseData.update_forward_refs()
