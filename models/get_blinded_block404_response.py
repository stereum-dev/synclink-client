...
class GetBlindedBlock404Response(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    GetBlindedBlock404Response - a model defined in OpenAPI

        code: The code of this GetBlindedBlock404Response [Optional].
...
GetBlindedBlock404Response.update_forward_refs()
