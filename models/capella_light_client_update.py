...
class CapellaLightClientUpdate(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    CapellaLightClientUpdate - a model defined in OpenAPI

        attested_header: The attested_header of this CapellaLightClientUpdate [Optional].
        next_sync_committee: The next_sync_committee of this CapellaLightClientUpdate [Optional].
        next_sync_committee_branch: The next_sync_committee_branch of this CapellaLightClientUpdate [Optional].
        finalized_header: The finalized_header of this CapellaLightClientUpdate [Optional].
        finality_branch: The finality_branch of this CapellaLightClientUpdate [Optional].
        sync_aggregate: The sync_aggregate of this CapellaLightClientUpdate [Optional].
        signature_slot: The signature_slot of this CapellaLightClientUpdate [Optional].
    """
...
CapellaLightClientUpdate.update_forward_refs()
