...
from models.get_light_client_updates_by_range_response_inner_data_one_of import GetLightClientUpdatesByRangeResponseInnerDataOneOf
from models.get_light_client_updates_by_range_response_inner_data_one_of1 import GetLightClientUpdatesByRangeResponseInnerDataOneOf1
...
class GetLightClientUpdatesByRangeResponseInnerData(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    GetLightClientUpdatesByRangeResponseInnerData - a model defined in OpenAPI

        attested_header: The attested_header of this GetLightClientUpdatesByRangeResponseInnerData [Optional].
        next_sync_committee: The next_sync_committee of this GetLightClientUpdatesByRangeResponseInnerData [Optional].
        ...
        finality_branch: The finality_branch of this GetLightClientUpdatesByRangeResponseInnerData [Optional].
...
GetLightClientUpdatesByRangeResponseInnerData.update_forward_refs()
