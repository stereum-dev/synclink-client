...
class SignedVoluntaryExit(BaseModel):
    """SignedVoluntaryExit - a model defined in OpenAPI

        message: The message of this SignedVoluntaryExit [Optional].
        signature: The signature of this SignedVoluntaryExit [Optional].
    """
...
SignedVoluntaryExit.update_forward_refs()
