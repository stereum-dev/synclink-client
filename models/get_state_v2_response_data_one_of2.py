...
class GetStateV2ResponseDataOneOf2(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    GetStateV2ResponseDataOneOf2 - a model defined in OpenAPI

        genesis_time: The genesis_time of this GetStateV2ResponseDataOneOf2 [Optional].
        genesis_validators_root: The genesis_validators_root of this GetStateV2ResponseDataOneOf2 [Optional].
        slot: The slot of this GetStateV2ResponseDataOneOf2 [Optional].
        fork: The fork of this GetStateV2ResponseDataOneOf2 [Optional].
        latest_block_header: The latest_block_header of this GetStateV2ResponseDataOneOf2 [Optional].
        block_roots: The block_roots of this GetStateV2ResponseDataOneOf2 [Optional].
        state_roots: The state_roots of this GetStateV2ResponseDataOneOf2 [Optional].
        historical_roots: The historical_roots of this GetStateV2ResponseDataOneOf2 [Optional].
        eth1_data: The eth1_data of this GetStateV2ResponseDataOneOf2 [Optional].
        eth1_data_votes: The eth1_data_votes of this GetStateV2ResponseDataOneOf2 [Optional].
        eth1_deposit_index: The eth1_deposit_index of this GetStateV2ResponseDataOneOf2 [Optional].
        validators: The validators of this GetStateV2ResponseDataOneOf2 [Optional].
        balances: The balances of this GetStateV2ResponseDataOneOf2 [Optional].
        randao_mixes: The randao_mixes of this GetStateV2ResponseDataOneOf2 [Optional].
        slashings: The slashings of this GetStateV2ResponseDataOneOf2 [Optional].
        previous_epoch_participation: The previous_epoch_participation of this GetStateV2ResponseDataOneOf2 [Optional].
        current_epoch_participation: The current_epoch_participation of this GetStateV2ResponseDataOneOf2 [Optional].
        justification_bits: The justification_bits of this GetStateV2ResponseDataOneOf2 [Optional].
        previous_justified_checkpoint: The previous_justified_checkpoint of this GetStateV2ResponseDataOneOf2 [Optional].
        current_justified_checkpoint: The current_justified_checkpoint of this GetStateV2ResponseDataOneOf2 [Optional].
        finalized_checkpoint: The finalized_checkpoint of this GetStateV2ResponseDataOneOf2 [Optional].
        inactivity_scores: The inactivity_scores of this GetStateV2ResponseDataOneOf2 [Optional].
        current_sync_committee: The current_sync_committee of this GetStateV2ResponseDataOneOf2 [Optional].
        next_sync_committee: The next_sync_committee of this GetStateV2ResponseDataOneOf2 [Optional].
        latest_execution_payload_header: The latest_execution_payload_header of this GetStateV2ResponseDataOneOf2 [Optional].
    """
...
GetStateV2ResponseDataOneOf2.update_forward_refs()
