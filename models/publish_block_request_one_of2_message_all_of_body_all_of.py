...
class PublishBlockRequestOneOf2MessageAllOfBodyAllOf(BaseModel):
    """PublishBlockRequestOneOf2MessageAllOfBodyAllOf - a model defined in OpenAPI

        randao_reveal: The randao_reveal of this PublishBlockRequestOneOf2MessageAllOfBodyAllOf [Optional].
        eth1_data: The eth1_data of this PublishBlockRequestOneOf2MessageAllOfBodyAllOf [Optional].
        graffiti: The graffiti of this PublishBlockRequestOneOf2MessageAllOfBodyAllOf [Optional].
        proposer_slashings: The proposer_slashings of this PublishBlockRequestOneOf2MessageAllOfBodyAllOf [Optional].
        attester_slashings: The attester_slashings of this PublishBlockRequestOneOf2MessageAllOfBodyAllOf [Optional].
        attestations: The attestations of this PublishBlockRequestOneOf2MessageAllOfBodyAllOf [Optional].
        deposits: The deposits of this PublishBlockRequestOneOf2MessageAllOfBodyAllOf [Optional].
        voluntary_exits: The voluntary_exits of this PublishBlockRequestOneOf2MessageAllOfBodyAllOf [Optional].
        sync_aggregate: The sync_aggregate of this PublishBlockRequestOneOf2MessageAllOfBodyAllOf [Optional].
    """
...
PublishBlockRequestOneOf2MessageAllOfBodyAllOf.update_forward_refs()
