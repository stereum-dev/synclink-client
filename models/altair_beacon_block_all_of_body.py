...
class AltairBeaconBlockAllOfBody(BaseModel):
    """AltairBeaconBlockAllOfBody - a model defined in OpenAPI
        ...
        graffiti: The graffiti of this AltairBeaconBlockAllOfBody [Optional].
        proposer_slashings: The proposer_slashings of this AltairBeaconBlockAllOfBody [Optional].
        attester_slashings: The attester_slashings of this AltairBeaconBlockAllOfBody [Optional].
        attestations: The attestations of this AltairBeaconBlockAllOfBody [Optional].
        deposits: The deposits of this AltairBeaconBlockAllOfBody [Optional].
        voluntary_exits: The voluntary_exits of this AltairBeaconBlockAllOfBody [Optional].
        sync_aggregate: The sync_aggregate of this AltairBeaconBlockAllOfBody [Optional].
    """
...
AltairBeaconBlockAllOfBody.update_forward_refs()
