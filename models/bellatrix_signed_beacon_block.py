...
class BellatrixSignedBeaconBlock(BaseModel):
    """BellatrixSignedBeaconBlock - a model defined in OpenAPI

        message: The message of this BellatrixSignedBeaconBlock [Optional].
        signature: The signature of this BellatrixSignedBeaconBlock [Optional].
    """
...
BellatrixSignedBeaconBlock.update_forward_refs()
