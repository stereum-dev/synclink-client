...
class DenebSignedBlobSidecar(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    DenebSignedBlobSidecar - a model defined in OpenAPI

        message: The message of this DenebSignedBlobSidecar [Optional].
        signature: The signature of this DenebSignedBlobSidecar [Optional].
    """
...
DenebSignedBlobSidecar.update_forward_refs()
