...
class GetStateV2ResponseDataOneOf4(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    GetStateV2ResponseDataOneOf4 - a model defined in OpenAPI

        genesis_time: The genesis_time of this GetStateV2ResponseDataOneOf4 [Optional].
        genesis_validators_root: The genesis_validators_root of this GetStateV2ResponseDataOneOf4 [Optional].
        ...
        historical_roots: The historical_roots of this GetStateV2ResponseDataOneOf4 [Optional].
        eth1_data: The eth1_data of this GetStateV2ResponseDataOneOf4 [Optional].
        eth1_data_votes: The eth1_data_votes of this GetStateV2ResponseDataOneOf4 [Optional].
        ...
        previous_justified_checkpoint: The previous_justified_checkpoint of this GetStateV2ResponseDataOneOf4 [Optional].
        current_justified_checkpoint: The current_justified_checkpoint of this GetStateV2ResponseDataOneOf4 [Optional].
        ...
        next_sync_committee: The next_sync_committee of this GetStateV2ResponseDataOneOf4 [Optional].
        latest_execution_payload_header: The latest_execution_payload_header of this GetStateV2ResponseDataOneOf4 [Optional].
        next_withdrawal_index: The next_withdrawal_index of this GetStateV2ResponseDataOneOf4 [Optional].
        next_withdrawal_validator_index: The next_withdrawal_validator_index of this GetStateV2ResponseDataOneOf4 [Optional].
...
GetStateV2ResponseDataOneOf4.update_forward_refs()
