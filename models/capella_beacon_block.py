...
class CapellaBeaconBlock(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    CapellaBeaconBlock - a model defined in OpenAPI

        slot: The slot of this CapellaBeaconBlock [Optional].
        proposer_index: The proposer_index of this CapellaBeaconBlock [Optional].
        parent_root: The parent_root of this CapellaBeaconBlock [Optional].
        state_root: The state_root of this CapellaBeaconBlock [Optional].
        body: The body of this CapellaBeaconBlock [Optional].
    """
...
CapellaBeaconBlock.update_forward_refs()
