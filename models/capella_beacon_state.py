...
class CapellaBeaconState(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    CapellaBeaconState - a model defined in OpenAPI

        genesis_time: The genesis_time of this CapellaBeaconState [Optional].
        genesis_validators_root: The genesis_validators_root of this CapellaBeaconState [Optional].
        slot: The slot of this CapellaBeaconState [Optional].
        fork: The fork of this CapellaBeaconState [Optional].
        latest_block_header: The latest_block_header of this CapellaBeaconState [Optional].
        block_roots: The block_roots of this CapellaBeaconState [Optional].
        state_roots: The state_roots of this CapellaBeaconState [Optional].
        historical_roots: The historical_roots of this CapellaBeaconState [Optional].
        eth1_data: The eth1_data of this CapellaBeaconState [Optional].
        eth1_data_votes: The eth1_data_votes of this CapellaBeaconState [Optional].
        eth1_deposit_index: The eth1_deposit_index of this CapellaBeaconState [Optional].
        validators: The validators of this CapellaBeaconState [Optional].
        balances: The balances of this CapellaBeaconState [Optional].
        randao_mixes: The randao_mixes of this CapellaBeaconState [Optional].
        slashings: The slashings of this CapellaBeaconState [Optional].
        previous_epoch_participation: The previous_epoch_participation of this CapellaBeaconState [Optional].
        current_epoch_participation: The current_epoch_participation of this CapellaBeaconState [Optional].
        justification_bits: The justification_bits of this CapellaBeaconState [Optional].
        previous_justified_checkpoint: The previous_justified_checkpoint of this CapellaBeaconState [Optional].
        current_justified_checkpoint: The current_justified_checkpoint of this CapellaBeaconState [Optional].
        finalized_checkpoint: The finalized_checkpoint of this CapellaBeaconState [Optional].
        inactivity_scores: The inactivity_scores of this CapellaBeaconState [Optional].
        current_sync_committee: The current_sync_committee of this CapellaBeaconState [Optional].
        next_sync_committee: The next_sync_committee of this CapellaBeaconState [Optional].
        latest_execution_payload_header: The latest_execution_payload_header of this CapellaBeaconState [Optional].
        next_withdrawal_index: The next_withdrawal_index of this CapellaBeaconState [Optional].
        next_withdrawal_validator_index: The next_withdrawal_validator_index of this CapellaBeaconState [Optional].
        historical_summaries: The historical_summaries of this CapellaBeaconState [Optional].
    """
...
CapellaBeaconState.update_forward_refs()
