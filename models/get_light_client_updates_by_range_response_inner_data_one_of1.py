...
class GetLightClientUpdatesByRangeResponseInnerDataOneOf1(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    GetLightClientUpdatesByRangeResponseInnerDataOneOf1 - a model defined in OpenAPI

        attested_header: The attested_header of this GetLightClientUpdatesByRangeResponseInnerDataOneOf1 [Optional].
        next_sync_committee: The next_sync_committee of this GetLightClientUpdatesByRangeResponseInnerDataOneOf1 [Optional].
        next_sync_committee_branch: The next_sync_committee_branch of this GetLightClientUpdatesByRangeResponseInnerDataOneOf1 [Optional].
        finalized_header: The finalized_header of this GetLightClientUpdatesByRangeResponseInnerDataOneOf1 [Optional].
        finality_branch: The finality_branch of this GetLightClientUpdatesByRangeResponseInnerDataOneOf1 [Optional].
        sync_aggregate: The sync_aggregate of this GetLightClientUpdatesByRangeResponseInnerDataOneOf1 [Optional].
        signature_slot: The signature_slot of this GetLightClientUpdatesByRangeResponseInnerDataOneOf1 [Optional].
    """
...
GetLightClientUpdatesByRangeResponseInnerDataOneOf1.update_forward_refs()
