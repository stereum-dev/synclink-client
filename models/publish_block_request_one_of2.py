...
class PublishBlockRequestOneOf2(BaseModel):
    ...
    PublishBlockRequestOneOf2 - a model defined in OpenAPI
        ...
        signed_block: The signed_block of this PublishBlockRequestOneOf2 [Optional].
        signed_blob_sidecars: The signed_blob_sidecars of this PublishBlockRequestOneOf2 [Optional].
    """
